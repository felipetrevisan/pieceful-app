  ...
  return (
    <Screen>
      ...
      <LinearGradient colors={[`${colors.accent}26`, `${colors.primary}22`]} style={[styles.hero, { borderColor: `${colors.accent}45`, borderRadius: colors.radius }]}>
        ...
        <Text style={[styles.copy, { color: colors.muted }]}>{session ? t("Puzzles, XP, amigos e conquistas são sincronizados com segurança.", "Puzzles, XP, friends and achievements are securely synced.") : t("Entre para sincronizar seus puzzles, conquistas e perfil entre dispositivos.", "Sign in to sync puzzles, achievements and your profile across devices.")}</Text>
      </LinearGradient>
