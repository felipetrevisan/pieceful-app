...
export default function AchievementsScreen() {
  ...
  const achievements = [
    { icon: "trophy-outline" as const, title: t("Mestre dos Quebra-cabeças", "Master Puzzler"), description: t("Finalize 10 quebra-cabeças em qualquer dificuldade.", "Finish 10 puzzles at any difficulty."), unlocked: completed >= 10, rarity: t("LENDÁRIO", "LEGENDARY"), progress: Math.min(100, completed * 10) },
    { icon: "timer-outline" as const, title: t("Demônio da Velocidade", "Speed Demon III"), description: t("Complete um quebra-cabeça sem usar dicas.", "Complete a puzzle without using hints."), unlocked: puzzles.some((p) => p.session.completedAt && p.session.hintsUsed === 0), rarity: t("ÉPICO", "EPIC"), progress: completed ? 100 : 0 },
