...
export default function SettingsScreen() {
  const { language, preferences, setLanguage, setTheme, t, theme, updatePreference } = useApp();
    ...
    <Screen>
      ...
      <Section title={t("AJUDA", "HELP")}>
        <View style={styles.helpRow}>
          <HelpCard icon="game-controller-outline" title={t("Controles", "Controller Help")} subtitle="Xbox · PlayStation" onPress={() => router.push("/help/controller" as never)} />
          <HelpCard icon="keypad-outline" title={t("Teclado", "Keyboard Help")} subtitle={t("Atalhos", "Shortcuts")} onPress={() => router.push("/help/keyboard" as never)} />
        </View>
      </Section>
...
const styles = StyleSheet.create({
  ...
  helpRow: { flexDirection: "row", gap: 12 }, helpPressable: { flex: 1 }, help: { minHeight: 154, borderWidth: 1, alignItems: "flex-start", justifyContent: "center", padding: 16 }, helpIcon: { width: 47, height: 47, borderRadius: 15, alignItems: "center", justifyContent: "center", marginBottom: 14 }, helpText: { fontFamily: "BricolageGrotesque_700Bold", fontSize: 17 }, helpSubtitle: { fontFamily: "Inter_600SemiBold", fontSize: 10, marginTop: 3 },
